...
class AssignmentListTab extends ConsumerWidget {
  // THAY ĐỔI QUAN TRỌNG: Nhận ClassModel
  final ClassModel classModel;
  const AssignmentListTab({super.key, required this.classModel});
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text(sessionDate == null ? 'Chưa chọn' : DateFormat.yMd().format(sessionDate!)),
                    ...
                    onTap: () async {
                      ...
                      if (pickedDate != null) {
                        setDialogState(() => sessionDate = pickedDate);
                      }
                    },
                  ),
                  ListTile(
                    ...
                    subtitle: Text(dueDate == null ? 'Chưa chọn' : DateFormat.yMd().format(dueDate!)),
                    trailing: const Icon(Icons.calendar_today),
                    onTap: () async {
                      final pickedDate = await showDatePicker(
                        context: context,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final assignmentsAsync = ref.watch(assignmentsProvider(classModel.id));
